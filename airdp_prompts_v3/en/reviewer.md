...
- **DO NOT perform the Judge or Phase 5 Orchestrator roles yourself.** Even if you can read `judge_phase4.md` or `orchestrator_phase5.md`, you must NOT act on them.
